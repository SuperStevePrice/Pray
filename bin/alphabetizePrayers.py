#!/usr/bin/env python3
"""
RETIRED (safe no-op) — Alphabetize the prayer <option> list in docs/index.html.
...
Its hardcoded 10-prayer list omitted Ave Verum Corpus, and its greedy regex would have replaced the whole current <option> block — silently dropping prayers from the dropdown — then committed and pushed.
